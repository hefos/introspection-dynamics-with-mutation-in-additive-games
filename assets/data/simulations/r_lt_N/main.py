...
for N in range(11, 100, 11):
    ...
    for seed in range(1,100):
        print(N, seed)
        pc = get_pc_from_sims(alphas=alphas, r=N/2, N=N, seed=seed)
        data = [N, seed, pc]
        df = pd.DataFrame([data], columns=["N", "seed", "pc"])
